...
-- 5. SELECT app_name FROM analytics WHERE rating >= 4.8 ORDER BY reviews DESC LIMIT 1; --
...
-- 8. SELECT * FROM analytics WHERE rating > 0 AND min_installs <=50 ORDER BY rating DESC; -- 
...
--FURTHER STUDY--
-- FS1. SELECT app_name, rating, category FROM analytics WHERE (rating, category) in (SELECT MAX(rating), category FROM analytics WHERE min_installs >= 50000GROUP BY category)ORDER BY category;
-- FS2. SELECT * FROM analytics WHERE app_name ILIKE '%facebook%'; --
-- FS3. SELECT * FROM analytics WHERE array_length(genres, 1) = 2; --
-- FS4. SELECT * FROM analytics WHERE genres @> '{"Education"}'; -- 